                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                '${selectedItem.description}', style: TextStyle(fontSize: 12),
                              ),
                            )
                          ],
                      ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ClipOval(
            child: Image.network(
                'https://avatars.githubusercontent.com/u/90590677?s=400&u=b4e1177d3bd7307402cd531976a562f9643ef9b3&v=4', // replace if you want
                width: 50,
                height: 50,
                fit: BoxFit.cover
            ),
...
final List<MountModel> mountItems = [
  ...
  MountModel(
      path: 'https://upload.wikimedia.org/wikipedia/commons/e/e0/Mauna_Loa_Volcano.jpg',
      name: 'Mauna Loa',
      description:
